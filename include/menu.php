                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">STMIK Sumedang</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl.Angkrek Situ No.19 Sumedang Phone: (0261)207395 Fax: (0261)207395 Email: info@stmik-sumedang.ac.id</p>';
                            }
                        }
                    ?>
                </div>
